...
unset style line
set style line 1  linetype 1 linecolor rgb "green"  linewidth 0.000 pointtype 7 pointsize default pointinterval 0
set style line 2  linetype 2 linecolor rgb "red"  linewidth 0.000 pointtype 5 pointsize default pointinterval 0
set style line 3  linetype 1 linecolor rgb "blue"  linewidth 2.000 pointtype 1 pointsize default pointinterval 0
unset style arrow
...
set title "Energía potencial total dependiendo del número de cargas" 
...
GNUTERM = "windows"
EpAnalitica = -0.627282518067511
plot '0-19-ffc.dat' using 1:2 with points linestyle 1 title 'Ep0',      '0-19-ffc.dat' using 1:3 with points linestyle 2 title 'Ep',      EpAnalitica lt 3 lw 2 lc rgb 'blue' title 'Ep Analítica'
#    EOF
