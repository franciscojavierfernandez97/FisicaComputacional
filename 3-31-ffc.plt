...
unset style line
set style line 1  linetype 1 linecolor rgb "red"  linewidth 1.000 pointtype 1 pointsize default pointinterval 0
set style line 2  linetype 2 linecolor rgb "blue"  linewidth 1.000 pointtype 2 pointsize default pointinterval 0
unset style arrow
...
GNUTERM = "windows"
plot '3-31-ffc.dat' with lines linestyle 1 title 'Sin obstáculo',      '3-31b-ffc.dat' with lines linestyle 2 title 'Con obstáculo'
#    EOF
