...
# set output '2-75-ffc-Logaritmica.png'
unset clip points
set clip one
unset clip two
...
set title "Representación logaritmica en el eje y" 
...
GNUTERM = "windows"
plot 'C:\Users\FRAN\Desktop\FisicaComputacional\Tema2\2-75-ffc\2-75-ffc.dat' using 1:2 with linespoints
#    EOF
