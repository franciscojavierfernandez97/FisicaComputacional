...
unset style line
set style line 1  linetype 1 linecolor rgb "blue"  linewidth 1.000 pointtype 1 pointsize default pointinterval 0
set style line 2  linetype 1 linecolor rgb "red"  linewidth 1.000 pointtype 1 pointsize default pointinterval 0
unset style arrow
...
set title "Gráficas de funciones" 
...
f2(x) = 1/cosh(x*pi/2)
GNUTERM = "windows"
GPFUN_f1 = "f1(x) = cos(x*pi/2)"
GPFUN_f2 = "f2(x) = 1/cosh(x*pi/2)"
plot f1(x) with lines ls 1 title 'cos(x*pi/2)',      f2(x) with lines ls 2 title '1/cosh(x*pi/2)'
#    EOF
